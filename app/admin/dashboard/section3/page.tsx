...
const Section3 = () => {
    ...
    if (selectedFile2resp !== "") {
      ...
      axios
        ...
        .then((response1) => {
          ...
          sectionData[0].videosresp = imageUrl1;
          setSectionData([...sectionData]);
          setcheck(true);
        })
        .catch((error) => {
  ...
  useEffect(() => {
    ...
    axios
      .get(`${serverLink}section/3`) // Change the URL accordingly
      .then((response) => {
    ...
    <DashboardLayout>
      <div className="p-10 relative h-[80vh] w-full flex">
        <div className="w-1/3 border-r-[1px]">
          <h1 className="text-2xl pb-4 font-bold">Section3</h1>
        ...
        <div className="w-1/3 px-10 border-r-[1px]">
          ...
          <div className="flex space-x-6">
            ...
            {previewImage2resp && (
              <video controls width={200} height={200}>
                <source src={previewImage2resp} type={selectedFile2resp.type} />
                Your browser does not support the video tag.
              </video>
            )}
          </div>
                  ...
                  <div className="flex space-x-10">
                    <div>
                      ...
                      <div>
                        ...
                        <video controls width={200} height={200}>
                          <source src={item.videos} type={selectedFile2.type} />
                        </video>
                      </div>
                    </div>
                    <div>
                      ...
                      <div>
                        <p className="pb-3 text-xl font-medium">Video</p>
                        <video controls width={200} height={200}>
                          <source src={item.videosresp} type={selectedFile2resp.type} />
                        </video>
                      </div>
                    </div>
                  </div>
